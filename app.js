    ...
    <tr>
      ...
      <td>
        <div class="row-actions" style="display:flex;gap:6px;justify-content:flex-end">
          ${p.canEdit ? `<button class="icon-btn" title="Editar" onclick="event.stopPropagation();editNotebook('${n.id}')"><i class="ti ti-pencil" style="font-size:15px"></i></button>` : ''}
          ...
          ${p.canDelete ? `<button class="icon-btn danger" title="Excluir" onclick="event.stopPropagation();deleteNotebook('${n.id}','${(n.modelo||'').replace(/'/g,'')}')"><i class="ti ti-trash" style="font-size:15px"></i></button>` : ''}
        </div>
      </td>
    </tr>`).join('');
}
